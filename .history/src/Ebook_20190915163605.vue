<template>
  <div class='ebook'>
    ...
    <!-- 阅读器 菜单栏 -->
    <MenuBar :ifTitleAndMenuShow="ifTitleAndMenuShow"  ref="menuBar" :fontSizeList="fontSizeList" :defaultFontSize="defaultFontSize" @changeFontSize="changeFontSize"></MenuBar>
  </div>
</template>
