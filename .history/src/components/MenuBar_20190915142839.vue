    ...
    <transition name="slide-up">
      <div class="setting-wrapper" v-show="ifSettingShow">
        ...
        <div class="setting-font-size">
          <div class="preview" ref="leftA" :style="{fontSize: minFontSize + 'px'}">A</div>
          ...
          <div class="preview" ref="rightA" :style="{fontSize: maxFontSize + 'px'}">A</div>
        </div>
      </div>
    </transition>
  </div>
...
export default {
  ...
  methods: {
    ...
    centerA () {
      ...
      let offsetA = eachSelectWidth / 4
      this.$refs.leftA.css({
        left: offsetA
      })
      this.$refs.rightA.css({
        right: offsetA
      })
    }
  },
