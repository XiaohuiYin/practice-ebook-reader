    ...
    <transition name="slide-up">
      <div class="setting-wrapper" v-show="ifSettingShow">
        ...
        <div class="setting-font-size">
          <div class="preview left" :style="{fontSize: minFontSize + 'px'}">A</div>
          ...
          <div class="preview right" :style="{fontSize: maxFontSize + 'px'}">A</div>
        </div>
      </div>
    </transition>
  </div>
...
export default {
  ...
  methods: {
    ...
    centerA () {
      ...
      // 使 "A" 居中需要的位移 = 每个选择块的宽度的四分之一(数学知识)
      this.$refs.fontSelect.offsetWidth / this.fontSizeList.length / 4
    }
  },
  computed: {
    minFontSize () { // 最小字号
